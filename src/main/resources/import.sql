...
insert into restaurant (id, name, tax_delivery, kitchen_id) values (5, 'Brazilian Beef', 20, 3);
insert into restaurant (id, name, tax_delivery, kitchen_id) values (6, 'Sumo Japan', 30, 4);
insert into restaurant (id, name, tax_delivery, kitchen_id) values (7, 'Sashimi Oss', 19, 4);
