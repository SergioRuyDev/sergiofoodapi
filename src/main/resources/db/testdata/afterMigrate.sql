...
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open, address_city_id, address_postalcode, address_street, address_number, address_district) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, true, 1, '10292', '5TH Avenue', '1000', 'Yorkville');
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, true);
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open) values (3, 'Tuk Tuk Indian Food', 15, 2, utc_timestamp, utc_timestamp, true);
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open) values (4, 'Carnival Brazilian', 25, 3, utc_timestamp, utc_timestamp, true);
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open) values (5, 'Brazilian Beef', 20, 3, utc_timestamp, utc_timestamp, true);
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open) values (6, 'Sumo Japan', 30, 4, utc_timestamp, utc_timestamp, true);
insert into restaurant (id, name, tax_delivery, kitchen_id, date_register, date_update, active, open) values (7, 'Sashimi Oss', 19, 4, utc_timestamp, utc_timestamp, true);
